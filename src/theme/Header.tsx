...
import AccordionArticleBody from "./AccordionArticleBody";
            ...
            <section class={classes.header}>
                <div class={classes.content}>
                    <div class={classes.title}>
                        <div
                            class={[classes.logo, classes.dropShadow].join(" ")}
                        >
                            <a href="/">
                        ...
                        <div
                            class={[classes.social, classes.dropShadow].join(
                                " ",
                            )}
                        >
                            <a target="_blank" href={header.meta.social.github}>
                                <MdiGithub />
                            </a>
                            <a
                                target="_blank"
                                href={header.meta.social.linkedin}
                            >
                                <MdiLinkedin />
                            </a>
                        </div>
                ...
                <section class={classes.intro}>
                    <div class={classes.content}>
                        <CardSection class={classes.wrapperBox}>
                            ...
                            <AccordionArticleBody article={header} />
                        </CardSection>
                    </div>
                </section>
            </Show>
